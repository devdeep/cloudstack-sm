...
public interface ManagementService {
     ...
     * @return Ternary<List<? extends Host>, List<? extends Host>, Map<Host, Boolean>> List of all Hosts in VM's cluster
     *         , list of Hosts with enough capacity and hosts requiring storage motion for migration.
     */
     ...
     *
     * @param Long volumeId
     * @return PairList<? extends StoragePool> List of storage pools
     */
    List<? extends StoragePool> listStoragePoolsForMigrationOfVolume(Long volumeId);
